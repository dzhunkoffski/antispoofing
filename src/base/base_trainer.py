...
class BaseTrainer:
    ...
    def __init__(self, model: BaseModel, criterion, metrics, optimizer, config, device, lr_scheduler):
        self.device = device
        self.config = config
    ...
    def _resume_checkpoint(self, resume_path):
        ...
        if (
                checkpoint["config"]["optimizer"] != self.config["optimizer"] or "lr_scheduler" not in checkpoint["config"] or
            ...
            if 'lr_scheduler' in checkpoint["config"]:
